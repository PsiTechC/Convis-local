    ...
    async def start_streaming_asr(self):
        ...
        try:
            ...
            dg_params = {
                ...
                'endpointing': '200',  # 200ms silence detection (faster than default)
                'vad_events': 'true',  # Voice activity detection
                'utterance_end_ms': '800',  # Finalize after 800ms silence
                'punctuate': 'true',
                'smart_format': 'true'
            }
                    ...
                    if alternatives:
                        ...
                        if transcript:
                            if is_final:
                                ...
                                # Trigger streaming LLM response
                                asyncio.create_task(self._process_streaming_response(transcript))
                            else:
