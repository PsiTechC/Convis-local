...
class AIAssistantCreate(BaseModel):
    ...
    # LLM Configuration
    llm_provider: Optional[str] = "openai"  # openai, azure, openrouter, deepseek, anthropic, groq, ollama
    ...
    use_streaming_mode: Optional[bool] = False  # Stream LLM response sentence-by-sentence for lower latency
...
class AIAssistantResponse(BaseModel):
    ...
    # LLM Configuration
    llm_provider: str = "openai"  # openai, azure, openrouter, deepseek, anthropic, groq, ollama
    ...
    use_streaming_mode: bool = False  # Stream LLM response sentence-by-sentence for lower latency
