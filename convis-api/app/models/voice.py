...
class VoiceMetadata(BaseModel):
    ...
    provider: Literal["cartesia", "elevenlabs", "openai", "sarvam", "piper", "xtts"] = Field(..., description="TTS provider")
...
class SaveVoiceRequest(BaseModel):
    ...
    voice_id: str
    provider: Literal["cartesia", "elevenlabs", "openai", "sarvam", "piper", "xtts"]
